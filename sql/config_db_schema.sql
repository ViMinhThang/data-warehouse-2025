...
VALUES
    (
        'AAPL,MSFT,GOOG,NVDA,TSLA,QCOM,AMD,META,AMZN,AVGO,CRM,SHOP,CDNS,ASML', -- all tickers in one string
        '1mo',
        '5m',
        './output/yfinance',
        ARRAY[
            '22130251@st.hcmuaf.edu.vn',
            'nguyenvanvang2626@gmail.com'
        ],
        3,
        TRUE,
